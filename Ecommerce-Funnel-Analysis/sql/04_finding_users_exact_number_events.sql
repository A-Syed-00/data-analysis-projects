...
-- Purpose: Create a user-level table with total counts per event type (view, cart, purchase) 
-- Input events_cleaned table 
-- Output: user_event_counts table 
-- Notes: This table is used for funnel flags and further analysis
-- ===========================================================================================
...
SELECT 
  user_id, 
  COUNT(event_type) AS total_number_events,
